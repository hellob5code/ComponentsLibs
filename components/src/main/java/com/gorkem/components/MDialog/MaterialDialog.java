package com.gorkem.components.MDialog;
...
import com.gorkem.components.MDialog.base.DialogBase;
import com.gorkem.components.MDialog.util.DialogUtils;
import com.gorkem.components.MDialog.util.RecyclerUtil;
import com.gorkem.components.MDialog.util.TypefaceHelper;
import com.gorkem.components.R;
...
public class MaterialDialog extends DialogBase implements View.OnClickListener {
     ...
     * Use {@link #setActionButton(com.gorkem.components.MDialog.DialogAction, int)} to change text, since the view returned here is not
