...
public class ViewDragHelper {
     ...
     * The callback's {@link com.gorkem.components.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link com.gorkem.components.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link com.gorkem.components.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
     ...
     * The child order is determined using {@link com.gorkem.components.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
